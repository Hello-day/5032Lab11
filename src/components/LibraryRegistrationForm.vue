...
const submitForm = () => {
  ...
  validateConfirmPassword(true) // Added
...
/**
 * Confirm password validation function, checks if two inputs match
 * @param blur: boolean - Only show error when losing focus
 */
